...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeListOfUri() {
      //  videoUriList.add(new Video("https://www.radiantmediaplayer.com/media/bbb-
        videoUriList.add(new Video("http://195.19.44.146:90/Friends.S07E01.mkv", Long.getLong("zero", 0)));
     ...
     //   subtitleList.add(new Subtitle(2, "German", "https://durian.blender.org/wp-content/content/subtitles/sintel_en.srt"));
        subtitleList.add(new Subtitle(1, "English", "http://195.19.44.146:90/Friends.S07E01.srt"));
